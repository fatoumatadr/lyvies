    ...
    <>
      ...
      <section className="relative h-[60vh] min-h-[450px] flex items-end overflow-hidden">
        <div
          ...
          style={{ backgroundImage: `url('${post.image}')`, backgroundColor: "#38261C" }}
        />
        <div className="absolute inset-0 bg-gradient-to-t from-noir-900 via-noir-900/40 to-noir-900/20" />
        <div className="relative z-10 container-lyvies pb-16">
          <motion.div variants={fadeUp} initial="hidden" animate="visible">
            {/* Breadcrumb */}
            <div className="flex items-center gap-2 mb-6">
              <Link href="/journal" className="text-[10px] uppercase tracking-[0.2em] font-jost text-oak/60 hover:text-oak transition-colors">
                Journal
              </Link>
              <span className="text-oak/30">/</span>
              <span className="text-[10px] uppercase tracking-[0.2em] font-jost text-noir-900/30">
                {post.category}
              </span>
            </div>
            ...
            <div className="flex items-center gap-4 mt-6">
              <span className="text-caption tracking-[0.15em] font-jost text-noir-900/40">
      ...
      <Section bg="warm">
        ...
        >
          ...
          <div className="prose-lyvies space-y-6">
            <p className="font-jost text-body-lg font-light text-noir-900/70 leading-[1.9] first-letter:text-5xl first-letter:font-jost first-letter:font-medium first-letter:text-oak first-letter:float-left first-letter:mr-3 first-letter:mt-1">
            ...
            <blockquote className="border-l-2 border-noir-900/10 pl-8 my-10">
              <p className="font-jost font-medium text-xl italic text-noir-900/70 leading-relaxed">
          ...
          <div className="mt-20 pt-10 border-t border-sable/30 flex justify-between items-center">
            <Link href="/journal" className="flex items-center gap-3 text-caption uppercase tracking-[0.2em] font-jost text-oak/60 hover:text-oak transition-colors">
